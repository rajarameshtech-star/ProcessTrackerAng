...
@Component({
   ...
   standalone: true,
   imports: [CommonModule, RouterModule, ButtonModule, IconsModule, DialogsModule, ReactiveFormsModule, InputsModule, DropDownsModule, IndicatorsModule, StatusChipComponent, PriorityChipComponent, LoadingStateComponent, DatePipe],
   template: `
